...
public interface ScanningModule {
	...
	//method for saving xml scanned data on a file and then return a String List with CVEs {String list because of compatibility issues from any scanning script}
