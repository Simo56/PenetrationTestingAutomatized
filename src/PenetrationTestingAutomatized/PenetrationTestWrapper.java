...
public class PenetrationTestWrapper {
	...
	public PenetrationTestWrapper(InetAddress ip) {
		//create the instances of the objects that will be used in this automatized penetration test
		this.ip = ip;
	...
	*/
	...
	public void runWithIP() {
		...
		if(!XMLFileParserClass.searchAndExtrapolateVulnerabilitiesFromNMAPXMLtoCVE()) {
